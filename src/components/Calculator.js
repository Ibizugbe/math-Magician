  ...
  return (
    <main>
      <div className="calculator-container animate__animated animate__rubberBand">
        <div className="calculator-display animate__animated animate__bounceInRight" onChange={displayResult}>
          <h1>
            {total}
            {operation}
            {next}
        ...
        <div className="calculator-keys animate__animated animate__bounce">
          ...
          <button type="button" name="%" onClick={handleClick}>%</button>
          <button type="button" name="&#247;" onClick={handleClick} className="bg-orange">&#247;</button>
          ...
          <button type="button" name="x" onClick={handleClick} className="bg-orange">&times;</button>
          ...
          <button type="button" name="+" onClick={handleClick} className="bg-orange">+</button>
          <button type="button" name="0" onClick={handleClick} className="span-2">0</button>
          <button type="button" name="." onClick={handleClick}>.</button>
          <button type="button" name="=" onClick={handleClick} className="bg-orange">=</button>
        </div>
      </div>
